...
from dataset_types import long_dataset_name_list, short_dataset_name_list, all_dataset_name_list, extra_up_to_2Mb_list, all_up_to_2Mb_dataset_list
...
if __name__ == "__main__":
    ...
    for dataset_name in all_up_to_2Mb_dataset_list:
        ...
        for augmentation in augmentations:
            ...
            results_df.to_csv("results_2Mb.csv", index=True)
